...
type =c("two-sample")
alternative = c("one-sided") #power analysis to determine required sample size 
```
...
powerTOSTtwo(alpha=0.05, N=63.77, low_eqbound_d=-0.5, high_eqbound_d=0.5)#calculating estimated power requiredfor zero effect
```
